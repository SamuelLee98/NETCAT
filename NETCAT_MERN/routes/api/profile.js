...
// @access  Private
router.put(
  // put request updates the mongo database
  // Since we are adding record to the experience array, we are updating the database instead of creating a new record --> ie. put instead of post
  '/experience',
  [
    auth,
    [
  ...
  async (req, res) => {
    ...
    try {
      ...
      profile.experience.unshift(newExp); // push to front of array
...
router.delete('/experience/:exp_id', auth, async (req, res) => {
  try {
    ...
    profile.experience.splice(removeIndex, 1); // remove element in array by index
...
router.put(
  ...
  async (req, res) => {
    ...
    try {
      ...
      profile.education.unshift(newEdu); // push to front of array
...
router.delete('/education/:edu_id', auth, async (req, res) => {
  try {
    ...
    profile.education.splice(removeIndex, 1); // remove element in array by index
